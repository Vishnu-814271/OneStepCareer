  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-600 via-orange-500 to-amber-500 flex flex-col items-center relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] left-[-5%] w-[500px] h-[500px] bg-brand-cyan/10 rounded-full blur-[120px] animate-pulse"></div>
      </div>
      ...
      <div className="w-full max-w-7xl z-10 px-6 py-12 flex flex-col items-center">
        ...
        <div className="w-full flex justify-between items-center mb-20 animate-in fade-in duration-700">
          <div className="flex items-center gap-3">
            ...
            <span className="font-heading font-black text-2xl text-white tracking-tighter uppercase">Tech<span className="text-white/80">Nexus</span></span>
          </div>
          <button 
        ...
        <div className="text-center space-y-8 mb-24 max-w-4xl animate-in slide-in-from-top-10 duration-1000">
          ...
          <h1 className="text-7xl md:text-9xl font-heading font-black text-white tracking-tighter leading-none drop-shadow-sm">
            ENGINEER YOUR <span className="text-white/80 italic">FUTURE.</span>
          </h1>
          <p className="text-orange-50 text-lg md:text-xl font-medium leading-relaxed max-w-2xl mx-auto italic">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-6">
            <button 
              ...
              className="px-14 py-6 bg-white text-orange-600 rounded-[28px] font-black text-sm uppercase tracking-[0.2em] shadow-2xl flex items-center gap-4 hover:scale-105 active:scale-95 transition-all w-full md:w-auto hover:bg-orange-50"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-32 w-full">
          <div className="bg-white/10 rounded-[40px] p-10 border border-white/20 hover:border-white/40 transition-all group backdrop-blur-md">
        ...
        {/* Footer Meta */}
        <div className="mt-32 pt-12 border-t border-white/10 w-full flex flex-col md:flex-row items-center justify-between gap-6 opacity-60">
